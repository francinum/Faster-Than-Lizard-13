...
/world/Reboot(var/reason, var/feedback_c, var/feedback_r, var/time)
	...
	spawn(0)
		if(ticker && ticker.round_end_sound)
			...
			world << sound(pick('sound/AI/newroundsexy.ogg','sound/misc/apcdestroyed.ogg','sound/misc/bangindonk.ogg','sound/misc/leavingtg.ogg','sound/misc/clownmac.ogg','sound/misc/just_another_day_take_1.ogg')) // random end sounds!! - LastyBatsy
	for(var/client/C in clients)
