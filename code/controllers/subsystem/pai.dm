...
//		addtimer(CALLBACK(src, .proc/spam_again), spam_delay)		//commenting this out kills spam protection but i'm going to fuck up everything else if i add callbacks
