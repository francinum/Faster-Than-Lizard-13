...
/turf/open/floor/proc/MakeDirty()
	...
	var/area/A = loc
				...
				//zero dirt
	if(!istype(A) || istype(A, /area/centcom) || istype(A, /area/shuttle/ftl/holodeck) || istype(A, /area/library) || istype(A, /area/janitor) || istype(A, /area/chapel) || istype(A, /area/mine/explored) || istype(A, /area/mine/unexplored) || istype(A, /area/solar) || istype(A, /area/atmos) || istype(A, /area/medical/virology))
		return
